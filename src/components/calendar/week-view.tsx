...
export function WeekView({
	...
	return (
		<div data-slot="week-view" className="flex h-full flex-col">
			...
			<div className="grid flex-1 grid-cols-8 overflow-auto min-h-0 scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-zinc-600 scrollbar-track-transparent">
