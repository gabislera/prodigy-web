...
export function DayView({
				...
				if (col.length === 0) {
					...
					const overlaps = col.some((c) =>
						areIntervalsOverlapping(
							...
							{ start: new Date(c.event.startDate), end: new Date(c.event.endDate) },
						),
					);
					if (!overlaps) {
						placed = true;
	...
	return (
		<div data-slot="day-view" className="flex h-full flex-col">
			...
			<div className="grid flex-1 grid-cols-[3rem_1fr] overflow-auto min-h-0 border-t border-border/70 sm:grid-cols-[4rem_1fr] scrollbar-thin scrollbar-thumb-rounded-full scrollbar-thumb-zinc-600 scrollbar-track-transparent">
				<div>
